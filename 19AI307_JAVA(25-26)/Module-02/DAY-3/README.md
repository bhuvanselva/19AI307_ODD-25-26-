...
## ALGORITHM :
Create a class Person with private variables name, age, and country

Define public getter and setter methods for each variable.

In main(), create a Person object and set values using setters.
...
```
## OUTPUT:
<img width="1140" height="654" alt="image" src="https://github.com/user-attachments/assets/ba1a4765-7014-46f4-b972-1ccb95761659" />
