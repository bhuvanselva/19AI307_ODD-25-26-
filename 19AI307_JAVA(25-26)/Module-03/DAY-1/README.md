...
Define a base class Customer with attributes customerId, name, and purchaseWeight.

Define RegularCustomer subclass with a 2% discount on the gold rate.

Define PremiumCustomer subclass with a 5% discount and 1% cashback on the final price.

Input the base gold rate per gram at runtime.

For each customer, calculate and display the final price (and cashback for premium).
...
## OUTPUT:
<img width="1290" height="746" alt="image" src="https://github.com/user-attachments/assets/acfd7e46-e7d8-492a-8a5e-a0f75af0afb3" />
